...
class TaskManager:
    ...
    async def collect_data(self, exchange, ticker, timeframe, limit, api_url):
        ...
        while True:
            ...
            #     print(f"""{exchange}_{ticker}_{
            #           timeframe} -> {formatted_date_time}""")
